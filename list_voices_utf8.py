...
try:
    ...
    # Filter for Vietnamese voices checking both language code and name
    vi_voices = [
        v for v in voices 
        if "Vietnamese" in v.get("language", "") 
        or "Tiếng Việt" in v.get("language", "")
        or "Vietnam" in v.get("language", "")
    ]
