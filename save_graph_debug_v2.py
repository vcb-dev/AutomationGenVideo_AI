...
# Testing simpler attachments field
fields = "id,message,created_time,permalink_url,full_picture,attachments,type"
params = {"fields": fields, "limit": 2, "access_token": token}

r = requests.get(url, params=params)
with open('debug_result_v2.json', 'w', encoding='utf-8') as f:
